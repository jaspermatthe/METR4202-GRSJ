...
2. Launch SLAM and navigation stack
    ...
    ros2 launch nav2_bringup navigation_launch.py # this was found on https://navigation.ros.org/tutorials/docs/navigation2_with_slam.html
...
8. Run this in command line to run the python file
...
# To move the bot to specified position and orientation
    ros2 topic pub -1 /goal_pose geometry_msgs/PoseStamped "{header: {frame_id: 'map'}, pose: {position: {x: 1.7, y: -0.5}, orientation: {w: 0.0}}}"
